...
public extension String {
    ...
    */
    ...
    /**
     ...
     - parameter gregorianFormat: Gregorian calendar format string to parse the receiver and convert to type of Date.
     */
    public func toDate(with gregorianFormat: String) -> Date? {
